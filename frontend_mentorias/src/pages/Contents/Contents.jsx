...
const Contents = () => {
  ...
  const handleDelete = () => {
    axios
      .delete(`https://web-build-prowess-mentorias-vipa.onrender.com/deleteContent/${selectedContent.id}`)
      .then((response) => {
        setDeleteOpen(false);
  ...
  const handleUpdate = (c) => {
    c.preventDefault();
    axios
      .patch(`https://web-build-prowess-mentorias-vipa.onrender.com/editContent/${selectedContent.id}`, {
  ...
  const fetchSearchContent = () => {
    if (search.length >= 3) {
      axios
        .get(`https://web-build-prowess-mentorias-vipa.onrender.com/searchContent/${search}`)
        .then((data) => {
