            ...
            <tbody className='divide-y divide-gray-100'>
              {
                products?.map((p, index) => (
                  <tr className={`${index % 2 == 0 ? 'bg-white' : 'bg-gray-100'} lg:max-h-full max-h-10`}>
                    ...
                    <td className='whitespace-nowrap p-3 text-sm text-gray-700'>{p.name}</td>
                    <td className='whitespace-nowrap p-3 text-sm text-gray-700'>{p.description}</td>
                    <td className='whitespace-nowrap p-3 text-sm text-gray-700'>{p.full_name}</td>
                    <td className='whitespace-nowrap p-3 text-sm text-gray-700'>{p.nameStore}</td>
